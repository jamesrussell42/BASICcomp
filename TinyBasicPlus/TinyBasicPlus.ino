...
static const unsigned char howmsg[]           PROGMEM =	"\nBad Number";
static const unsigned char sorrymsg[]         PROGMEM = "Not enough memory!";
static const unsigned char initmsg[]          PROGMEM = "TinyBasic+ " kVersion;
static const unsigned char memorymsg[]        PROGMEM = " bytes free.";
#ifdef ARDUINO
#ifdef ENABLE_EEPROM
static const unsigned char eeprommsg[]        PROGMEM = " EEProm total.";
static const unsigned char eepromamsg[]       PROGMEM = " EEProm bytes available.";
#endif
#endif
static const unsigned char breakmsg[]         PROGMEM = "\nbreak!";
